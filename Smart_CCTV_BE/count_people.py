...
def cont():
    ...
    def captu(): 
        ...
        while True:
            ...
            contorc,_ = cv2.findContours(diffc, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
    ...
    def right():
        ...
        while True:
            ...
            contorr,_ = cv2.findContours(diffr, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
    ...
    def left():
        ...
        while True:     
            ...
            contor,_ = cv2.findContours(diff, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
            for cont in contor :
